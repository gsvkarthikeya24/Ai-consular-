        ...
        <div className="min-h-screen pb-20">
            ...
            <div className="pt-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12 animate-slide-up">
                    <Card onClick={() => navigate('/analytics')} className="cursor-pointer bg-surface/40 hover:bg-surface/60 backdrop-blur-md border-primary/20">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-sm text-text-muted mb-1 font-medium uppercase tracking-wider">Tasks Completed</p>
                                <p className="text-4xl font-bold text-white font-heading">{stats.tasks_completed}</p>
                            </div>
                            <div className="p-3 bg-primary/10 rounded-xl border border-primary/20 shadow-[0_0_15px_rgba(6,182,212,0.15)]">
                    ...
                    <Card>
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-sm text-text-muted mb-1 font-medium uppercase tracking-wider">Courses</p>
                                <p className="text-4xl font-bold text-white font-heading">{stats.courses_recommended}</p>
                            </div>
                            <div className="p-3 bg-secondary/10 rounded-xl border border-secondary/20 shadow-[0_0_15px_rgba(168,85,247,0.15)]">
                    ...
                    <Card>
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-sm text-text-muted mb-1 font-medium uppercase tracking-wider">Internships</p>
                    ...
                    <Card onClick={() => navigate('/analytics')} className="cursor-pointer bg-surface/50 border-orange-500/20">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-sm text-text-muted mb-1 font-medium uppercase tracking-wider">Readiness</p>
                                <p className="text-4xl font-bold text-white font-heading">{stats.career_readiness}%</p>
                            </div>
                            <div className="p-3 bg-orange-500/10 rounded-xl border border-orange-500/20 shadow-[0_0_15px_rgba(249,115,22,0.15)]">
